...
public class DataSeeder {
    ...
    CommandLineRunner seed(TransformerRepo transformerRepo,
        ...
        return args -> {
            ...
            var t1 = make(transformerRepo, "TX-001", "Kandy",   500, "Colombo",    "EN-122-A", "Bulk",         "Near substation");
            var t2 = make(transformerRepo, "TX-002", "Colombo", 300, "Colombo",    "EN-122-B", "Distribution", "");
            var t3 = make(transformerRepo, "TX-003", "Jaffna",  200, "Maharagama", "EN-123-A", "Bulk",         "");
            var t4 = make(transformerRepo, "TX-004", "Galle",   400, "Nugegoda",   "EN-124-B", "Distribution", "");
            var t5 = make(transformerRepo, "TX-005", "Matara",  250, "Nugegoda",   "EN-125-A", "Bulk",         "");

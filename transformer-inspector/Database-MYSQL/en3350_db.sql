...
CREATE TABLE `annotations` (
  ...
  `source` enum('ai','human') COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_type` enum('created','edited','deleted','approved','rejected') COLLATE utf8mb4_unicode_ci DEFAULT 'created',
...
CREATE TABLE `inspections` (
  ...
  `weather_condition` enum('SUNNY','CLOUDY','RAINY') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `inspections` VALUES (_binary '™\“ÔÖòäMIØy0ìWhT','INS-001',_binary 'F\Îˇ¥ÙCí¥dr\–X/\‹8',NULL,_binary '>\ÿ*^I≥I\r£d∑∑\ÿH',NULL,'SUNNY','IN_PROGRESS','This is transformer 1 in the dataset','Prabath','2025-10-01 23:37:55',NULL,'2025-10-01 23:37:55','2025-10-01 23:57:06',_binary '\Ã7Å∑¯LK£úyë˙õ\ﬁÒ'),(_binary '\—V›üíª@êã®ŒòÜ¥Lº','INS-002',_binary '\\˝\€\‡ÄºBJΩ\Îà\‡Z˝µ',NULL,_binary 'î\›-`ÆN∏§\Î\Â@j',NULL,'CLOUDY','COMPLETED','This is transformer 10 in the data set','admin','2025-10-02 00:09:25',NULL,'2025-10-02 00:09:25','2025-10-02 00:35:10',_binary '?ß\Œh\ƒ\‘CD™†˙^êäΩr');
...
-- Dump completed on 2025-10-02 11:36:13
